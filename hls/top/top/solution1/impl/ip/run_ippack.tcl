...
set solution_dir "C:/Users/qjm/Desktop/demo/yolo4_tiny_acc/hls/top/top/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {conv_mac_muladd_4bkb
...
conv_mul_11s_4ns_8jQ
conv_mac_muladd_49j0
conv_mac_muladd_5bak
conv_mac_muladd_6bbk
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 in1_V W 0x0 "Data signal of in1_V" {{0 32 in1_V W 0 "Bit 31 to 0 Data signal of in1_V"}}} {0x18 in2_V W 0x0 "Data signal of in2_V" {{0 32 in2_V W 0 "Bit 31 to 0 Data signal of in2_V"}}} {0x20 in3_V W 0x0 "Data signal of in3_V" {{0 32 in3_V W 0 "Bit 31 to 0 Data signal of in3_V"}}} {0x28 in4_V W 0x0 "Data signal of in4_V" {{0 32 in4_V W 0 "Bit 31 to 0 Data signal of in4_V"}}} {0x30 w1_V W 0x0 "Data signal of w1_V" {{0 32 w1_V W 0 "Bit 31 to 0 Data signal of w1_V"}}} {0x38 w2_V W 0x0 "Data signal of w2_V" {{0 32 w2_V W 0 "Bit 31 to 0 Data signal of w2_V"}}} {0x40 w3_V W 0x0 "Data signal of w3_V" {{0 32 w3_V W 0 "Bit 31 to 0 Data signal of w3_V"}}} {0x48 w4_V W 0x0 "Data signal of w4_V" {{0 32 w4_V W 0 "Bit 31 to 0 Data signal of w4_V"}}} {0x50 b_V W 0x0 "Data signal of b_V" {{0 32 b_V W 0 "Bit 31 to 0 Data signal of b_V"}}} {0x58 out1_V W 0x0 "Data signal of out1_V" {{0 32 out1_V W 0 "Bit 31 to 0 Data signal of out1_V"}}} {0x60 out2_V W 0x0 "Data signal of out2_V" {{0 32 out2_V W 0 "Bit 31 to 0 Data signal of out2_V"}}} {0x68 out3_V W 0x0 "Data signal of out3_V" {{0 32 out3_V W 0 "Bit 31 to 0 Data signal of out3_V"}}} {0x70 out4_V W 0x0 "Data signal of out4_V" {{0 32 out4_V W 0 "Bit 31 to 0 Data signal of out4_V"}}} {0x78 ch_in W 0x0 "Data signal of ch_in" {{0 32 ch_in W 0 "Bit 31 to 0 Data signal of ch_in"}}} {0x80 ch_out W 0x0 "Data signal of ch_out" {{0 32 ch_out W 0 "Bit 31 to 0 Data signal of ch_out"}}} {0x88 fsize W 0x0 "Data signal of fsize" {{0 32 fsize W 0 "Bit 31 to 0 Data signal of fsize"}}} {0x90 stride W 0x0 "Data signal of stride" {{0 32 stride W 0 "Bit 31 to 0 Data signal of stride"}}} {0x98 kernel W 0x0 "Data signal of kernel" {{0 32 kernel W 0 "Bit 31 to 0 Data signal of kernel"}}} {0xa0 act W 0x0 "Data signal of act" {{0 32 act W 0 "Bit 31 to 0 Data signal of act"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL m_axi_FM1 m_axi_FM2 m_axi_FM3 m_axi_FM4 m_axi_W1 m_axi_W2 m_axi_W3 m_axi_W4"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_FM1 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_FM1"
        data_width "32"
        param_prefix "C_M_AXI_FM1"
    ...
    m_axi_FM2 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_FM2"
        data_width "32"
        param_prefix "C_M_AXI_FM2"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_FM3 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_FM3"
        data_width "32"
        param_prefix "C_M_AXI_FM3"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_FM4 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_FM4"
        data_width "32"
        param_prefix "C_M_AXI_FM4"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_W4 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_W4"
        data_width "32"
        param_prefix "C_M_AXI_W4"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 5.5 machine 64 combinational 0 latency undef II x}
