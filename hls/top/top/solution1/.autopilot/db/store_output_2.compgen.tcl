...
set out_width 31
set exp i0*i1+i2
set arg_lists {i0 {14 0 +} i1 {16 0 +} m {30 0 +} i2 {31 0 +} p {31 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 32
set exp i0*i1+i2
set arg_lists {i0 {3 0 +} i1 {14 0 +} m {17 0 +} i2 {31 0 +} p {32 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { fm_out_buff_V_address0 { O 10 vector } fm_out_buff_V_ce0 { O 1 bit } fm_out_buff_V_q0 { I 16 vector } } \
} "
} else {
