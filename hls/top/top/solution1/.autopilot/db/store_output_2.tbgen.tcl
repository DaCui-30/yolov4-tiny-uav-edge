...
set C_modelName {store_output.2}
set C_modelType { void 0 }
set C_modelArgList {
	{ out_V int 16 regular {axi_master 1}  }
	{ out_V_offset int 31 regular  }
	{ fm_out_buff_V int 16 regular {array 676 { 1 3 } 1 1 }  }
	{ n int 16 regular  }
	{ r int 16 regular  }
	{ c int 16 regular  }
...
set portList { 
	...
	{ fm_out_buff_V_address0 sc_out sc_lv 10 signal 2 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_urem_10ns_5nmb6_U39", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mul_4ns_16nsncg_U40", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_urem_10ns_5nmb6_U41", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mul_4ns_16nsncg_U42", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mul_mul_16nsocq_U43", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mac_muladd_1pcA_U44", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mac_muladd_3qcK_U45", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mac_muladd_3qcK_U46", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mac_muladd_3kbM_U47", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mac_muladd_7lbW_U48", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "701", "Max" : "701"}
	, {"Name" : "Interval", "Min" : "701", "Max" : "701"}
]}
...
set Spec2ImplPortList { 
	...
	fm_out_buff_V { ap_memory {  { fm_out_buff_V_address0 mem_address 1 10 }  { fm_out_buff_V_ce0 mem_ce 1 1 }  { fm_out_buff_V_q0 mem_dout 0 16 } } }
