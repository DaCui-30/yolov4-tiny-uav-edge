...
set out_width 31
set exp i0*i1+i2
set arg_lists {i0 {16 0 +} i1 {16 0 +} m {31 0 +} i2 {16 0 +} p {31 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 33
set exp i0*i1+i2
set arg_lists {i0 {16 0 +} i1 {3 0 +} m {19 0 +} i2 {32 1 +} p {33 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set out_width 13
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {6 0 +} m {13 0 +} i2 {5 0 +} p {13 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { fm_in_buff_V_address0 { O 12 vector } fm_in_buff_V_ce0 { O 1 bit } fm_in_buff_V_we0 { O 1 bit } fm_in_buff_V_d0 { O 16 vector } } \
} "
} else {
