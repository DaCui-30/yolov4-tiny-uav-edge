...
// ==============================================================
#ifndef __conv_mul_mul_16nsHfu__HH__
#define __conv_mul_mul_16nsHfu__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_16nsHfu) {
    ...
    SC_CTOR(conv_mul_mul_16nsHfu):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
