...
// ==============================================================
#ifndef __conv_mul_32s_32s_tde__HH__
#define __conv_mul_32s_32s_tde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_32s_32s_tde) {
    ...
    SC_CTOR(conv_mul_32s_32s_tde):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
