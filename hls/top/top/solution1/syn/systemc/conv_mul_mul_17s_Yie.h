...
// ==============================================================
#ifndef __conv_mul_mul_17s_Yie__HH__
#define __conv_mul_mul_17s_Yie__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_17s_Yie) {
    ...
    SC_CTOR(conv_mul_mul_17s_Yie):  ACMP_mul_su_U ("ACMP_mul_su_U") {
