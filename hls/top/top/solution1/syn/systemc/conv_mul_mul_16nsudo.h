...
// ==============================================================
#ifndef __conv_mul_mul_16nsudo__HH__
#define __conv_mul_mul_16nsudo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_16nsudo) {
    ...
    SC_CTOR(conv_mul_mul_16nsudo):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
