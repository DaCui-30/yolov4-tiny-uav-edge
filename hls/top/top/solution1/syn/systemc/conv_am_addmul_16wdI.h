...
// ==============================================================
#ifndef __conv_am_addmul_16wdI__HH__
#define __conv_am_addmul_16wdI__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_am_addmul_16wdI) {
    ...
    SC_CTOR(conv_am_addmul_16wdI):  simcore_am_0_U ("simcore_am_0_U") {
