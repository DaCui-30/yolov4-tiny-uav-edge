...
// ==============================================================
#ifndef __conv_ama_addmuladfu1__HH__
#define __conv_ama_addmuladfu1__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_ama_addmuladfu1) {
    ...
    SC_CTOR(conv_ama_addmuladfu1):  simcore_ama_0_U ("simcore_ama_0_U") {
