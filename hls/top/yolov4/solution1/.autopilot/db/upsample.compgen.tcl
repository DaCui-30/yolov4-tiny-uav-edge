...
set out_width 15
set exp i0*i1+i2
set arg_lists {i0 {4 0 +} i1 {5 0 +} m {9 0 +} i2 {15 0 +} p {15 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
set out_width 17
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {11 0 +} m {17 0 +} i2 {5 0 +} p {17 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
