...
set C_modelArgList {
	{ fm_in_buff_0_V int 16 regular {array 169 { 0 3 } 0 1 }  }
	{ fm_in_buff_1_V int 16 regular {array 169 { 0 3 } 0 1 }  }
	{ fm_in_buff_2_V int 16 regular {array 169 { 0 3 } 0 1 }  }
	{ fm_in_buff_3_V int 16 regular {array 169 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ basePixAddr sc_in sc_lv 16 signal 13 } 
	{ fm_size sc_in sc_lv 16 signal 14 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mul_mul_16nsudo_U88", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mac_muladd_1vdy_U89", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	fm_in_buff_0_V { ap_memory {  { fm_in_buff_0_V_address0 mem_address 1 8 }  { fm_in_buff_0_V_ce0 mem_ce 1 1 }  { fm_in_buff_0_V_we0 mem_we 1 1 }  { fm_in_buff_0_V_d0 mem_din 1 16 } } }
	fm_in_buff_1_V { ap_memory {  { fm_in_buff_1_V_address0 mem_address 1 8 }  { fm_in_buff_1_V_ce0 mem_ce 1 1 }  { fm_in_buff_1_V_we0 mem_we 1 1 }  { fm_in_buff_1_V_d0 mem_din 1 16 } } }
	fm_in_buff_2_V { ap_memory {  { fm_in_buff_2_V_address0 mem_address 1 8 }  { fm_in_buff_2_V_ce0 mem_ce 1 1 }  { fm_in_buff_2_V_we0 mem_we 1 1 }  { fm_in_buff_2_V_d0 mem_din 1 16 } } }
	fm_in_buff_3_V { ap_memory {  { fm_in_buff_3_V_address0 mem_address 1 8 }  { fm_in_buff_3_V_ce0 mem_ce 1 1 }  { fm_in_buff_3_V_we0 mem_we 1 1 }  { fm_in_buff_3_V_d0 mem_din 1 16 } } }
