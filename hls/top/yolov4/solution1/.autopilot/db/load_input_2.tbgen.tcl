...
set C_modelName {load_input.2}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_V int 16 regular {axi_master 0}  }
	{ in_V_offset int 31 regular  }
	{ fm_in_buff_V int 16 regular {array 2704 { 0 3 } 0 1 }  }
	{ n int 16 regular  }
	{ r int 16 regular  }
	{ c int 16 regular  }
	{ fsize int 16 regular  }
	{ size int 16 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_V", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "fm_in_buff_V", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "n", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "r", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "c", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "fsize", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ fm_in_buff_V_address0 sc_out sc_lv 12 signal 2 } 
	{ fm_in_buff_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ fm_in_buff_V_we0 sc_out sc_logic 1 signal 2 } 
	{ fm_in_buff_V_d0 sc_out sc_lv 16 signal 2 } 
	{ n sc_in sc_lv 16 signal 3 } 
	{ r sc_in sc_lv 16 signal 4 } 
	{ c sc_in sc_lv 16 signal 5 } 
	{ fsize sc_in sc_lv 16 signal 6 } 
	{ size sc_in sc_lv 16 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fm_in_buff_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fm_in_buff_V", "role": "we0" }} , 
 	{ "name": "fm_in_buff_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "fm_in_buff_V", "role": "d0" }} , 
 	{ "name": "n", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "n", "role": "default" }} , 
 	{ "name": "r", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "r", "role": "default" }} , 
 	{ "name": "c", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "c", "role": "default" }} , 
 	{ "name": "fsize", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "fsize", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_urem_12ns_6ndEe_U9", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mac_muladd_1eOg_U10", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mac_muladd_1fYi_U11", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mac_muladd_1g8j_U12", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mul_mul_16nshbi_U13", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mac_muladd_1g8j_U14", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mac_muladd_3ibs_U15", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mul_mul_16nshbi_U16", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_mac_muladd_8jbC_U17", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2732", "Max" : "2732"}
...
set Spec2ImplPortList { 
	...
	fm_in_buff_V { ap_memory {  { fm_in_buff_V_address0 mem_address 1 12 }  { fm_in_buff_V_ce0 mem_ce 1 1 }  { fm_in_buff_V_we0 mem_we 1 1 }  { fm_in_buff_V_d0 mem_din 1 16 } } }
	n { ap_none {  { n in_data 0 16 } } }
	r { ap_none {  { r in_data 0 16 } } }
	c { ap_none {  { c in_data 0 16 } } }
	fsize { ap_none {  { fsize in_data 0 16 } } }
