...
// ==============================================================
#ifndef __conv_mul_16ns_5nsVhK__HH__
#define __conv_mul_16ns_5nsVhK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_16ns_5nsVhK) {
    ...
    SC_CTOR(conv_mul_16ns_5nsVhK):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
