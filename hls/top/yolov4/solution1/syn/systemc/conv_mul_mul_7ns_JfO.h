...
// ==============================================================
#ifndef __conv_mul_mul_7ns_JfO__HH__
#define __conv_mul_mul_7ns_JfO__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_7ns_JfO) {
    ...
    SC_CTOR(conv_mul_mul_7ns_JfO):  ACMP_mul_us_U ("ACMP_mul_us_U") {
