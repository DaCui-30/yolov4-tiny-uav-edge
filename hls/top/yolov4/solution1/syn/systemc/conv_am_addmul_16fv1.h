...
// ==============================================================
#ifndef __conv_am_addmul_16fv1__HH__
#define __conv_am_addmul_16fv1__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_am_addmul_16fv1) {
    ...
    SC_CTOR(conv_am_addmul_16fv1):  simcore_am_1_U ("simcore_am_1_U") {
