...
// ==============================================================
#ifndef __conv_mul_mul_16s_ft1__HH__
#define __conv_mul_mul_16s_ft1__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_mul_16s_ft1) {
    ...
    SC_CTOR(conv_mul_mul_16s_ft1):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
