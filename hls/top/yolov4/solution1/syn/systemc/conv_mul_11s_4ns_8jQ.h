...
// ==============================================================
#ifndef __conv_mul_11s_4ns_8jQ__HH__
#define __conv_mul_11s_4ns_8jQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_11s_4ns_8jQ) {
    ...
    SC_CTOR(conv_mul_11s_4ns_8jQ):  ACMP_mul_su_U ("ACMP_mul_su_U") {
