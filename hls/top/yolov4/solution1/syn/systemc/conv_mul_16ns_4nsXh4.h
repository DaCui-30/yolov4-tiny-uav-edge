...
// ==============================================================
#ifndef __conv_mul_16ns_4nsXh4__HH__
#define __conv_mul_16ns_4nsXh4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_16ns_4nsXh4) {
    ...
    SC_CTOR(conv_mul_16ns_4nsXh4):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
