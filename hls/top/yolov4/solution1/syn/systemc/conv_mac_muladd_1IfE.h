...
// ==============================================================
#ifndef __conv_mac_muladd_1IfE__HH__
#define __conv_mac_muladd_1IfE__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mac_muladd_1IfE) {
    ...
    SC_CTOR(conv_mac_muladd_1IfE):  simcore_mac_12_U ("simcore_mac_12_U") {
