...
// ==============================================================
#ifndef __conv_mul_4ns_16nsncg__HH__
#define __conv_mul_4ns_16nsncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_mul_4ns_16nsncg) {
    ...
    SC_CTOR(conv_mul_4ns_16nsncg):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
